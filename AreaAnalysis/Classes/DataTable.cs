...
namespace AreaAnalysis.Classes
{
    ...
    {
        private readonly NotifyCollectionChangedAction _action = NotifyCollectionChangedAction.Reset;
        public DataTable()
        {
        ...
        private void Row_PropertyChanged(object sender, PropertyChangedEventArgs e)
        {
            ...
            OnCollectionChanged(new NotifyCollectionChangedEventArgs(_action));
        }
